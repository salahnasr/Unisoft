...
""
                        "}\n"
""));
        tableView = new QTableView(Maintenance);
        tableView->setObjectName(QStringLiteral("tableView"));
        tableView->setGeometry(QRect(10, 10, 721, 471));
        pushButton_ADD = new QPushButton(Maintenance);
        pushButton_ADD->setObjectName(QStringLiteral("pushButton_ADD"));
        pushButton_ADD->setGeometry(QRect(70, 484, 51, 51));
        pushButton_ADD->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon;
        icon.addFile(QStringLiteral(":/Icones/Ressources/edit-notes.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_ADD->setIcon(icon);
        pushButton_ADD->setIconSize(QSize(46, 49));
        pushButton_Edit = new QPushButton(Maintenance);
        pushButton_Edit->setObjectName(QStringLiteral("pushButton_Edit"));
        pushButton_Edit->setGeometry(QRect(11, 484, 51, 51));
        pushButton_Edit->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/Icones/Ressources/add-notes.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_Edit->setIcon(icon1);
        pushButton_Edit->setIconSize(QSize(64, 48));
        cancel = new QPushButton(Maintenance);
        cancel->setObjectName(QStringLiteral("cancel"));
        cancel->setGeometry(QRect(669, 483, 61, 51));
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/Icones/Ressources/exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        cancel->setIcon(icon2);
        cancel->setIconSize(QSize(55, 44));
        pushButton_delete = new QPushButton(Maintenance);
        pushButton_delete->setObjectName(QStringLiteral("pushButton_delete"));
        pushButton_delete->setGeometry(QRect(130, 484, 51, 51));
        pushButton_delete->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/Icones/Ressources/delete.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_delete->setIcon(icon3);
        pushButton_delete->setIconSize(QSize(58, 54));
        pushButton_refresh = new QPushButton(Maintenance);
        pushButton_refresh->setObjectName(QStringLiteral("pushButton_refresh"));
        pushButton_refresh->setGeometry(QRect(190, 485, 60, 51));
        pushButton_refresh->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/Icones/Ressources/reload_refresh.000.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_refresh->setIcon(icon4);
        pushButton_refresh->setIconSize(QSize(52, 48));
        tableView->raise();
    ...
    {
        Maintenance->setWindowTitle(QApplication::translate("Maintenance", "Esprit-RP : Maintenance", 0));
