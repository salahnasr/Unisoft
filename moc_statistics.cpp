...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Statistics_t, stringdata) + ofs \
...
const QMetaObject Statistics::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Statistics.data,
      qt_meta_data_Statistics,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Statistics.stringdata))
