...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Maintenance_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 113, 29)
    },
    "Maintenance\0on_cancel_clicked\0\0"
...
const QMetaObject Maintenance::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Maintenance.data,
      qt_meta_data_Maintenance,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Maintenance.stringdata))
